<x-app-layout>
    ...
    <div class="relative bg-white overflow-x-auto w-11/12 mx-auto border my-8">
        <div class="header text-left border-b w-full py-4 bg-gray-50">
            <h1 class="text-lg w-11/12 mx-auto text-gray-600">Types</h1>
        </div>
        <div class="text-right pb-8 border-b w-11/12 mx-auto">
            <div class="mt-9">
                <a href="{{ route('types.create') }}" class="bg-green-400 hover:bg-green-600 text-white py-3 px-4 rounded">Add new Type</a>
            </div>
        </div>
        <table class="w-11/12 mb-7 mt-2 mx-auto text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white text-lg border-t">
                    ...
                    <td class="px-6 py-4">{{ $type->category->name }}</td>
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('types.edit', $type) }}" class="text-white bg-yellow-400 hover:bg-yellow-600 py-3 px-5 rounded mx-1">Edit</a>
